...
use Cms\CmsBundle\Entity\Archivos;
use Cms\CmsBundle\Form\ArchivosType;
...
class ArchivosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CmsBundle:Archivos')->findAll();

        return $this->render('CmsBundle:Archivos:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CmsBundle:Archivos:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Archivos $entity)
    {
        $form = $this->createForm(new ArchivosType(), $entity, array(
            'action' => $this->generateUrl('archivos_new'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CmsBundle:Archivos')->find($id);
        ...
        return $this->render('CmsBundle:Archivos:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CmsBundle:Archivos:edit.html.twig', array(
            'entity'      => $entity,
